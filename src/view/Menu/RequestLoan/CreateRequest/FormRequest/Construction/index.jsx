...
import { getRequestLinks, createRequestLink } from "../../../../../../Api/requestLink";
  ...
  return (
    <form className={`container-fluid ${styles.formBlock}`} onSubmit={handleSubmit} style={{ maxWidth: '100%', margin: '0 auto', background: 'none', boxShadow: 'none', border: 'none' }}>
      ...
      <div className="d-flex align-items-center mb-4 gap-3">
        <h4 className="my_title_color fw-bold mb-0" style={{ letterSpacing: 0.5 }}>Solicitud Construction</h4>
        {externalLink && (
          <>
